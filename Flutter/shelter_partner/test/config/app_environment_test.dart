...
void main() {
  group('AppEnvironment', () {
    test('development() should create development environment with correct properties', () {
    ...
    test('production() should create production environment with correct properties', () {
      ...
      expect(env.serviceUrls, isA<ServiceUrls>());
      expect(env.serviceUrls.corsImagesUrl, contains('cors-images-222422545919'));
    });
