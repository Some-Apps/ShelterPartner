...
void main() {
  group('ServiceUrls', () {
    test(
      'development() should create ServiceUrls with development defaults',
      () {
        ...
        expect(
          urls.deleteVolunteerUrl,
          'https://delete-volunteer-dev-222422545919.us-central1.run.app',
        );
        expect(
          urls.inviteVolunteerUrl,
          'https://invite-volunteer-dev-222422545919.us-central1.run.app',
        );
        expect(
          urls.placesApiUrl,
          'https://places-api-dev-222422545919.us-central1.run.app',
        );
        expect(
          urls.placesApiDetailsUrl,
    ...
    test('corsImageUrl() should build correct CORS image URL', () {
      ...
      expect(
        result,
        'https://cors-images-222422545919.us-central1.run.app?url=https%3A%2F%2Fexample.com%2Fimage.jpg',
      );
    });

    test(
      'placesApiDetailsUrlWithPlaceId() should build correct Places API details URL',
      () {
        final urls = ServiceUrls.production();
        ...
        expect(
          result,
          'https://places-api-details-222422545919.us-central1.run.app?place_id=ChIJN1t_tDeuEmsRUsoyG83frY4',
        );
      },
    );
